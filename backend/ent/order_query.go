...
func (oq *OrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Order, error) {
	...
	if query := oq.withOwner; query != nil {
		if err := oq.loadOwner(ctx, query, nodes, nil,
			func(n *Order, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
...
func (oq *OrderQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Order, init func(*Order), assign func(*Order, *User)) error {
