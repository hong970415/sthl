...
func (pq *ProductQuery) QueryOwner() *UserQuery {
...
func (pq *ProductQuery) WithOwner(opts ...func(*UserQuery)) *ProductQuery {
	query := (&UserClient{config: pq.config}).Query()
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	...
	if query := pq.withOwner; query != nil {
		if err := pq.loadOwner(ctx, query, nodes, nil,
			func(n *Product, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Product, init func(*Product), assign func(*Product, *User)) error {
